package net.alexanderheavens.methodicalkitchen.core.tests.pantry.events;
...
public class ItemChangeEventTest {
	...
	public void testCreateBasicItemChangeEvent() {
		...
		final ItemChangeEvent testItemChangeEvent = new ItemChangeEvent(
				oldName, item);
	...
	public void testCreateNullOldNameItemChangeEvent() {
		...
		try {
			...
			final ItemChangeEvent testChangeEvent = new ItemChangeEvent(null,
					newTestItem);
			fail("Able to create ItemChangeEvent with null oldName");
		} catch (final NullPointerException nullPointerException) {
			assertEquals("ItemChangeEvent oldName",
	...
	public void testCreateNullItemChangeEvent() {
		...
		try {
			@SuppressWarnings("unused")
			final ItemChangeEvent testChangeEvent = new ItemChangeEvent(
					oldName, null);
